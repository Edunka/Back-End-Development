...
$sql = "INSERT INTO Teachers (TeacherName, Birthday, Gender,
TeacherAddress, TeacherEmail, TeacherPhone, TeacherSalary, BackgroundCheck, ClassID, AssistantID) VALUES ('$name', '$birth', '$gender', '$address', '$email', '$number',
'$salary', '$background', '$class', '$assistant')";
...
<!-- navbar -->
    ...
    <div class="container">
     ...
     basic labels and input fields -->
                ...
                <form action="new-teacher.php" method="post" class="container-fluid student-form col-md-6">
                    <h2>Add Teacher</h2>
                    <div class="">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control" alt="date of birth"required name="birthday" placeholder="year-month-day">
                    </div>
                    <div class="">
                    ...
                    <?php
                    // links assistant to the new teacher
				            $sql = mysqli_query($link, "SELECT AssistantID, AssistantName FROM TeacherAssistant");
				            while ($row = $sql->fetch_assoc()){
