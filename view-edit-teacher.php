...
if (isset($_POST['submit'])){
  ...
  $sql = "UPDATE Teachers SET  TeacherAddress = '$address', Gender = '$gender', TeacherPhone = '$number',
  TeacherEmail = '$email', TeacherSalary = '$salary', BackgroundCheck = '$background' WHERE TeacherID = '$id' ";
...
<?php
  if (isset($_POST['delete'])){
    ...
    $tid = $_POST['tid'];
    $sql = "DELETE FROM Teachers WHERE TeacherID = '$tid' ";
...
<!-- image -->
      ...
      <div class="table-responsive mt-2 border-top">
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $sql = mysqli_query($link, "SELECT TeacherID, TeacherName, Birthday, Gender, TeacherAddress, TeacherEmail, TeacherPhone, 
                TeacherSalary, BackgroundCheck, ClassID, AssistantID FROM Teachers");
      ...
      <form action="view-edit-teacher.php" method="post" class="container-fluid text-center w-50 mb-2 border border-dark border-5 p-2 rounded">
            <h2>UPDATE A TEACHER</h2>
            <div class="">
              <label for="id">ID</label>
              <input type="text" class="form-control" id="id" placeholder="Teacher ID"
          ...
          <form class="container-fluid text-center w-50 mb-2 border border-dark border-5 p-2 rounded" 
           action="view-edit-teacher.php" method="post">
    ...
    $sql = mysqli_query($link, "SELECT TeacherID  FROM Teachers");
    while ($row = $sql->fetch_assoc()){
    echo "
    
        <option>{$row['TeacherID']}</option>
